...
#define RCC_IT_LISRDY                    ((uint8_t)0x01)
...
#define RCC_IT_CSS                       ((uint8_t)0x80)
 ...
 #define IS_RCC_GET_IT(IT) (((IT) == RCC_IT_LISRDY) || ((IT) == RCC_IT_LSERDY) || \
...
#define RCC_RTCCLKSource_LIS             ((uint32_t)0x00000200)
#define RCC_RTCCLKSource_HSE_Div128      ((uint32_t)0x00000300)
#define IS_RCC_RTCCLK_SOURCE(SOURCE) (((SOURCE) == RCC_RTCCLKSource_LSE) || \
                                      ((SOURCE) == RCC_RTCCLKSource_LIS) || \
...
#define RCC_FLAG_LISRDY                  ((uint8_t)0x61)
...
#define RCC_FLAG_LPWRRST                 ((uint8_t)0x7F)
 ...
 #define IS_RCC_FLAG(FLAG) (((FLAG) == RCC_FLAG_HSIRDY) || ((FLAG) == RCC_FLAG_HSERDY) || \
                            ...
                            ((FLAG) == RCC_FLAG_LISRDY) || ((FLAG) == RCC_FLAG_PINRST) || \
...
void RCC_LISCmd(FunctionalState NewState);
